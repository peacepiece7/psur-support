<script setup lang="ts">
  ...
  import PubOrganismsStep1 from '~/components/views/pub/organisms/PubOrganismsStep1.vue'
  import PubOrganismsStep2 from '~/components/views/pub/organisms/PubOrganismsStep2.vue'
  import PubOrganismsStep3 from '~/components/views/pub/organisms/PubOrganismsStep3.vue'
  ...
  const STEPS: StepperStep[] = [
    { step: 1, title: 'Form Validation(1)' },
    { step: 2, title: 'Form Validation(2)' },
